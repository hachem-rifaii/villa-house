...
class OffPlan extends Component
{
    use WithPagination;
    ...
    public function render()
    {
        ...
        try {
            ...
            $query = Property::query()->where('off_plan', true);
            ...
            $properties = Property::where('off_plan', true)->paginate(10);
        }
    
        return view('livewire.home.off-plan', [
